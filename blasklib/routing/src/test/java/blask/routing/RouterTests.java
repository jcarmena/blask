...
public class RouterTests {
    ...
    public void parameters() {
        ...
        View viewApellido = new View("GET", "/hola/<apellido>/despedida", "adios_apellido", false,
                "adios_apellido.process");
        View defaultView = new View(null, null, "default", false, "default.process");
    ...
    public void regex() {
        Router router = new Router();
        View view = new View("GET", "/p/[project:[abc234]+]/f/[item:item[0-9]+]/all", "regex1", false,
                "regex1.process");
        View defaultView = new View(null, null, "default", false, "default.process");
        router.addView(view);
        router.setDefaultView(defaultView);
